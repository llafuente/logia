...
function_body:
  ...
  store ptr @.struct.init, ptr %0, align 8, !dbg !8
  %p = load ptr, ptr %0, align 8, !dbg !8
  %1 = getelementptr inbounds nuw %point, ptr %p, i32 0, i32 0, !dbg !8
  %2 = load i64, ptr %1, align 4, !dbg !8
  %p1 = load ptr, ptr %0, align 8, !dbg !8
  %3 = getelementptr inbounds nuw %point, ptr %p1, i32 0, i32 1, !dbg !8
  %4 = load i64, ptr %3, align 4, !dbg !8
  %5 = call i64 @logia_intrinsics_bin_add_i64_i64(i64 %2, i64 %4), !dbg !9
  ret i64 %5, !dbg !8
}
...
!9 = !DILocation(line: 9, column: 11, scope: !10)
!10 = distinct !DILexicalBlock(scope: !4, file: !1, line: 6, column: 20)
