...
function_body:
  ...
  %a1 = load i64, ptr %a, align 4, !dbg !14
  %b2 = load i64, ptr %b, align 4, !dbg !16
  %2 = call i64 @logia_intrinsics_bin_add_i64_i64(i64 %a1, i64 %b2), !dbg !14
  ret i64 %2, !dbg !17
}

define i64 @main() !dbg !18 {
function_body:
  %0 = call i64 @sum(i64 10, i64 15), !dbg !21
  ret i64 %0, !dbg !23
}
...
!1 = !DIFile(filename: "function-parameters.logia", directory: ".\\tests\\logia\\")
...
!16 = !DILocation(line: 2, column: 15, scope: !15)
!17 = !DILocation(line: 2, column: 4, scope: !15)
!18 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 5, type: !19, spFlags: DISPFlagDefinition, unit: !0)
!19 = !DISubroutineType(types: !20)
!20 = !{!7}
!21 = !DILocation(line: 6, column: 11, scope: !22)
!22 = distinct !DILexicalBlock(scope: !18, file: !1, line: 5, column: 20)
!23 = !DILocation(line: 6, column: 4, scope: !22)
